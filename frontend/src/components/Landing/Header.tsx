...
export function Header() {
    ...
    return (
        <header className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${scrolled ? 'bg-white/40 backdrop-blur-sm shadow-md' : ''}`} id="header">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-20">
              ...
              <div>
                <Link to="/login" className="hidden sm:inline-block text-yellow-500 font-semibold px-5 py-2.5 rounded-lg text-sm hover:opacity-90 transition-all duration-300">
